...
app.get('/cds-services', (request, response) => {
    ...
    let fhir_lab_reports_genetic = {
        hook: 'order-select',
        id: 'fhir_lab_reports_genetic',
        title: 'Hooks service endpoint for the fhir-lab-reports-genetic project',
        ...
        prefetch: {
            ...
            hook : 'RequestGroup?subject={{context.patientId}}&code=fhir_lab_reports_genetic_response'
        }
    };

    let discoveryEndpointServices = {
        services: [ fhir_lab_reports_genetic ]
    };
 ...
 */
app.post('/cds-services/fhir_lab_reports_genetic', (request, response) => {
    let implication = {};
